...
public class VcfResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vcf_result);
        ...
        //val
        tv = findViewById(R.id.vcf_tv);
        img = findViewById(R.id.vcf_imageView);
        cons = findViewById(R.id.cons);
    ...
    public void save_qr(View view) {
        ...
        savePhotoToSDCard(bitmap, "/sdcard/二维码助手", "VCF_" + ran);
        file = new File("/sdcard/二维码助手/VCF_" + ran + ".png");
